...
Routine reservation, charger, TMAP, subsidy, CDSID, and competitor-price updates
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--cdsid-checked-at", type=iso_timestamp)
...
def main() -> None:
    ...
    field_values = {
        ...
        "cdsidCheckedAt": args.cdsid_checked_at,
    }
